...
![[P3L6-what-is-virtualization.png]]
...
![[P3L6-virtualization-models-bare-metal.png]]
...
![[P3L6-virtualization-model-hosted.png]]
...
![[P3L6-passthrough-model.png]]In this approach, the guest VM has exclusive access to a device. In addition, the VM can directly access the device, without interacting with the VMM. This model is also called the **VMM-bypass model**.
...
![[P3L6-hypervisor-direct-model.png]]
...
![[P3L6-split-device-driver-model.png]]
