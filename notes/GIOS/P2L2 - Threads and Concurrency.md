...
![[P2L2-thread-visual-metaphor.png]]


### Process vs Thread
![[P2L2-process-vs-thread.png]]
...
![[P2L2-benefits-of-multithreading.png]]
...
![[P2L2-benefits-applications-and-code.png]]
...
![[P2L2-threads-and-concurrency.png]]
...
### Thread Creation
![[P2L2-thread-creation.png]]**THREAD TYPE**
...
![[P2L2-thread-creation-example.png]]

### Mutexes
##### How is the list updated?
![[P2L2-linkedlist-example.png]]
...
![[P2L2-condition-variable-api.png]]
It must be able to:
...
![[P2L2-readers-writer-problem.png]]
...
![[P2L2-reader-writer-example-1.png]]
...
![[P2L2-reader-writer-critical-section.png]]
...
![[P2L2-critical-section-structure-with-proxy-var.png]]
...
![[P2L2-kernel-user-level-threads.png]]
...
##### Example
- Process scope:
![[P2L2-process-scope-threads.png]]
...
2. Boss assigns work by placing work in **producer/consumer queue**:
   ![[P2L2-boss-workers-pattern-queue.png]]
